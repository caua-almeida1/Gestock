...
const Exames = () => {
    ...
    const [activeStep, setActiveStep] = useState(2); // Definindo o terceiro círculo como ativo
                            ...
                            <div className="rh_add_dados-form_content">
                                <div className="rh_add_dados-form_header">
                                    ...
                                    <div className="rh_add_dados-form_title">
                                        ...
                                        <p>Cadastrar as datas dos exames que o funcionário deve realizar</p>
                                    </div>
                                </div>

                                <div className="rh_add_form-input_container">
                                    <div className="rh_add_form-input_exams_container">
                                        {[
                                            ["Data do exame de admissão", "data-admissao-1"],
                                            ["Data do exame de retorno de afastamento", "data-retorno-1"],
                                        ].map(([label, id]) => (
                                            <div className="rh_add_form-input_exams" key={id}>
                                                <div className="rh_add_exames-input-container">
                                                    <div className="rh_add_exames_content">
                                                        <h4>{label}</h4>
                                                        <input className="rh_add_date-input_exames required-input" type="date" id={id} />
                                                    </div>
                                                </div>
                                            </div>
                                        ))}
                                    ...
                                    <div className="rh_add_form-input_exams_container">
                                        {[
                                            ["Data do exame periódico", "data-admissao-2"],
                                            ["Data do exame demissional", "data-retorno-2"],
                                        ].map(([label, id]) => (
                                            <div className="rh_add_form-input_exams" key={id}>
                                                <div className="rh_add_exames-input-container">
                                                    <div className="rh_add_exames_content">
                                    ...
                                    {[
                                        ["Data do exame por mudança de função", "data-admissao-3"],
                                    ].map(([label, id]) => (
                                        <div className="rh_add_form-input_exams" key={id}>
                                            <div className="rh_add_exames-input-container">
                                                <div className="rh_add_exames_content">
